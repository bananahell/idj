...
Sprite::~Sprite() { SDL_DestroyTexture(Sprite::texture); }
...
void Sprite::Open(std::string file) {
  ...
  if (SDL_QueryTexture(Sprite::texture, nullptr, nullptr, &width, &height) !=
      0) {
...
void Sprite::Render(int x, int y) {
  ...
  if (SDL_RenderCopy(Game::GetInstance().GetRenderer(), Sprite::texture,
                     &clipRect, &dstRect) != 0) {
...
int Sprite::GetWidth() { return Sprite::width; }

int Sprite::GetHeight() { return Sprite::height; }
